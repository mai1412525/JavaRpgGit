...
class Epi1_2Yes extends Speak_text{
	...
	public void run() {
		...
		speak.S("みさき「…」",30);
		speak.S(name+"「部長。」",30);
		speak.S("みさき「どうしたんだい？^^」",30);
		speak.S(name+"「なんで木刀なんか持ってるんですか？」",30);
		speak.S("みさき「深夜の学校は何が来るかわからないからね！護身用」",30);
		speak.S("「ほら、君も襲ってくるかもしれないでしょ？」",30);
		speak.S(name+"「いや、襲うわけないじゃないですかー」",30);
		speak.S("みさき「ほんとかなぁ」",30);
		speak.S(name+"「ほ、ほら、つきましたよ？はやく調査しましょう！ね？」",30);
		speak.S("みさき「まあ、いいだろう」",30);
		speak.S("[理科準備室]",30);
		speak.S("みさき「夜と昼だと、また一味違いますなぁ」",30);
		speak.S("＃ここからはMAP上で探索することができます。七不思議解決を目指しましょう。＃",50);
		speak.S("//操作方法//",50);
		speak.S("移動：十字キー、アクション：スペースキー",50);
